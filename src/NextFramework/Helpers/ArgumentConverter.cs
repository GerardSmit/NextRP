...
namespace NextFramework.Helpers
{
    internal static class ArgumentConverter
    {
        ...
        public static object[] ConvertToObjects(ArgumentsData data)
        {
        ...
        public static object ConvertToObject(ArgumentData data)
        {
            switch ((ArgumentValueType) data.ValueType)
            {
                ...
                default:
                    throw new NotSupportedException($"Conversion not implemented for ValueType {data.ValueType}");
            }
        }
        ...
        public static IEntity ConvertToEntity(EntityData data)
        {
            if (Collections.TryGetPool(data.Type, out var pool) == false)
            {
                var entityType = (EntityType) data.Type;

                throw new NotSupportedException($"Conversion not implemented for ValueType {entityType}");
            }
