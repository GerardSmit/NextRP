...
{
    public interface IPlayerCollection : IPool<IPlayer>
    {
        /// <summary>
        ...
        /// <exception cref="ArgumentNullException"><paramref name="message" /> is null (empty message is allowed)</exception>
        Task BroadcastAsync(string message, Vector3 position, float range, uint dimension = Constants.GlobalDimension);
