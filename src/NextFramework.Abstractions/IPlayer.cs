...
namespace NextFramework
{
    public interface IPlayer : IEntity
    {
        ...
        /// <summary>
        /// The token whenever the player disconnects.
        /// </summary>
        ...
        /// <exception cref="EntityDeletedException">This entity was deleted before</exception>
        Task CallClientAsync(string eventName, params object[] arguments);
        ...
        /// <exception cref="EntityDeletedException">This entity was deleted before</exception>
        Task CallClientAsync(string eventName, IEnumerable<object> arguments);

        /// <summary>
        /// Send an event to the players browser.
        /// </summary>
        /// <param name="eventName">Name of the event</param>
        /// <param name="arguments">Arguments of the event</param>
        /// <exception cref="ArgumentNullException"><paramref name="eventName" /> is null or empty</exception>
        /// <exception cref="EntityDeletedException">This entity was deleted before</exception>
        Task CallBrowserAsync(string eventName, params object[] arguments);
        ...
        /// <exception cref="ArgumentNullException"><paramref name="eventName" /> is null or empty, <paramref name="arguments"/> is null</exception>
        /// <exception cref="EntityDeletedException">This entity was deleted before</exception>
        Task CallBrowserAsync(string eventName, IEnumerable<object> arguments);
